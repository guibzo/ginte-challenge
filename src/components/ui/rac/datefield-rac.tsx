  ...
  return (
    <DateSegmentRac
      className={composeRenderProps(className, (className) =>
        cn(
          'data-focused:bg-accent data-invalid:data-focused:bg-destructive data-focused:data-placeholder:text-muted-foreground data-focused:text-muted-foreground data-invalid:data-placeholder:text-destructive data-invalid:text-destructive data-placeholder:text-muted-foreground/70 outline-hidden data-disabled:cursor-not-allowed data-disabled:opacity-50 data-invalid:data-focused:text-muted-foreground data-invalid:data-focused:data-placeholder:text-muted-foreground inline rounded p-0.5 text-white caret-transparent data-[type=literal]:px-0 data-[type=literal]:text-muted-foreground/70',
          className,
        ),
      )}
      {...props}
